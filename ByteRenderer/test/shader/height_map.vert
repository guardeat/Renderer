...
void main() {
    float height = texture(uAlbedo, aTexCoord).r;
    vec3 displacedPos = aPos + aNormal * height * uScale.y;
    vec3 translated = translate(displacedPos, uPosition, uScale, uRotation);

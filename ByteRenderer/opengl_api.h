...
namespace Byte {
    ...
    public:
        ...
        struct RenderArrayAPI {
            static RArrayData build(SolidGeometry& geometry, bool isStatic) {
            ...
            static RArrayData quad(Buffer<float> positions, Buffer<uint32_t> indices) {
                ...
                return RArrayData{ VAO, VBO, 0, 0, EBO, 0 };
            }

            static void clear(RArrayData& renderArraydata) {
        ...
        struct ShaderAPI {
            ...
            static void clearShader(uint32_t id) {
                glDeleteShader(id);
            }
        ...
        struct GBufferAPI {
            static GBufferData build(size_t width, size_t height) {
            ...
            static void clear(GBufferData& gBufferData) {
            ...
            static void clearContent(GBufferData& gBufferData) {
                bind(gBufferData);
                glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
            }

            static void bind(GBufferData& gBufferData) {
        ...
        struct TextureAPI {
            static void bind(unsigned int textureID, GLenum textureUnit = GL_TEXTURE0) {
